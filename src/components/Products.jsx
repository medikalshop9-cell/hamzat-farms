...
function ProductCard({ item, index }) {
  ...
  return (
    <div
      ref={ref}
      className={"card p-6 flex flex-col gap-4 reveal" + (visible ? " visible" : "")}
      style={{ transitionDelay: (index * 0.1) + "s" }}
    >
      <span className="text-4xl" style={{ display: "inline-block", transition: "transform 0.3s cubic-bezier(0.34,1.56,0.64,1)" }}
  ...
  return (
    <section id="products" className="py-24 bg-white">
      <div className="max-w-6xl mx-auto px-5">
        ...
        <div
          ref={headRef}
          className={"text-center mb-14 reveal" + (headVisible ? " visible" : "")}
        >
